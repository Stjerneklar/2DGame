...
public class CharacterController2D : MonoBehaviour
{
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if (m_Grounded && jump)
		{
			...
			m_Grounded = false;
			m_JumpForce = 100 * mytools.settings.PlayerStatsJumpHeightPts + 300;  // 300, 400, 500, 600, 700, 800
			Debug.Log("Jump force: " + m_JumpForce + " @pts " + mytools.settings.PlayerStatsJumpHeightPts);

			m_Rigidbody2D.AddForce(new Vector2(0f, m_JumpForce));
            //Invoke("SetExtraJump",0.5f);
            //print("Jumped!");
        }
        // Extra Jump
        //if (extraJump && jump)
    ...
    //{
    //    extraJump = true;
    //    print("Extra Jump Now Availible!");
    //}
